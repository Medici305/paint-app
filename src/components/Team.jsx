...
const Team = () => {
  ...
  return (
    ...
    >
      <Row
        className="d-flex flex-column justify-content-center align-items-end bg-white border border-success shadow rounded"
        style={{ height: "auto" }}
      >
        ...
        <Col className="h-75 d-flex justify-content-center align-items-end">
          {" "}
          <Card
            className="text-center border-success pt-3 rounded"
            style={{ width: "28rem" }}
          >
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                experience. I'm extremely passionate about web development.
                Coding for me is more than knowledge, it helps me to express my
